...
describe("[MODULE]: Complete registration use case", () => {
  beforeEach(async () => {
    ...
    sut = new CompleteRegistrationUseCase(usersRepository, companyMembersRepository, tokensRepository);
  ...
  it("should not call updateAccountStatus if member status is different from PENDING", async () => {
    const spyUpdateAccountStatus = vi.spyOn(companyMembersRepository, "updateAccountStatus");
