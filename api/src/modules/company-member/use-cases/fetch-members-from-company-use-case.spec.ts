...
describe("[MODULE]: Fetch members from company use case", () => {
  beforeEach(async () => {
    ...
    sut = new FetchMembersFromCompanyUseCase(companyMembersRepository, companiesRepository);
  ...
  it("should be able to fetch company members", async () => {
    ...
    expect((companyMembers[0].extraData as ICompanyMemberExtraData).permissions).includes("ADMIN");
  });
