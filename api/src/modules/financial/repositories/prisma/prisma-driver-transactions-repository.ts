...
export class PrismaDriverTransactionsRepository implements DriverTransactionsRepository {
  async create(data: Prisma.DriverTransactionUncheckedCreateInput, tx?: Prisma.TransactionClient) {
