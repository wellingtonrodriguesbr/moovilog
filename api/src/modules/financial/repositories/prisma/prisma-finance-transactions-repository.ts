...
export class PrismaFinanceTransactionsRepository implements FinanceTransactionsRepository {
  async create(data: Prisma.FinanceTransactionUncheckedCreateInput, tx?: Prisma.TransactionClient) {
