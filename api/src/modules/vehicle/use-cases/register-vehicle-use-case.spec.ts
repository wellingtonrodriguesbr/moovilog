...
describe("[MODULE]: Register vehicle use case", () => {
  beforeEach(async () => {
    ...
    sut = new RegisterVehicleUseCase(companyMembersRepository, vehiclesRepository, permissionService);
  ...
  it("should be able to register a vehicle", async () => {
    ...
    expect(vehiclesRepository.items[0].creatorId).toEqual("company-member-id-01");
  });
