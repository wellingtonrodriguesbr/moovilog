...
import { IVehicle, IVehicleBody, IVehicleCategory, IVehicleType } from "@/modules/vehicle/interfaces/vehicle";
...
export class RegisterVehicleUseCase {
  ...
  async execute({
    ...
    if (vehicleAlreadyExistsInCompanyWithPlate) {
      throw new VehicleAlreadyExistsInCompanyError("There is already a vehicle registered with this plate");
    }
    ...
    if (transformedTrailerPlate) {
      ...
      if (vehicleAlreadyExistsInCompanyWithTrailerPlate) {
        throw new VehicleAlreadyExistsInCompanyError("There is already a vehicle registered with this trailer plate");
      }
    }
