...
export interface VehiclesRepository {
  ...
  findVehicleInCompanyByPlate(plate: string, companyId: string): Promise<Vehicle | null>;
  findVehicleInCompanyByTrailerPlate(trailerPlate: string, companyId: string): Promise<Vehicle | null>;
  ...
  update(vehicleId: string, data: Prisma.VehicleUncheckedUpdateInput): Promise<void>;
}
