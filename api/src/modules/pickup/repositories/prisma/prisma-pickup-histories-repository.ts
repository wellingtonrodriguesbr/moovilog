...
export class PrismaPickupHistoriesRepository implements PickupHistoriesRepository {
  async create(data: Prisma.PickupHistoryUncheckedCreateInput, tx?: Prisma.TransactionClient) {
