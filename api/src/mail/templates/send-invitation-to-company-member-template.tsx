        ...
        <Body className="bg-white font-sans">
          <Container>
            ...
            <Text className="text-[20px]">
              Você recebeu um convite para se juntar a {senderName} e companhia dentro da plataforma do{" "}
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              Abaixo está o seu link de acesso, basta clicar no botão e concluir seu cadastro. Vamos juntos simplificar
              a gestão logística no Brasil?! 🎉
            </Text>
