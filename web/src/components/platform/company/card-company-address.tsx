      ...
      <CardContent className="space-y-6 mt-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <fieldset className="space-y-2">
            <Label>CEP:</Label>
            <Input readOnly value={formatCEP(companyAddress.address.zipCode)} />
          </fieldset>
          <fieldset className="space-y-2">
            <Label>Nome:</Label>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <fieldset className="col-span-2 md:col-span-1 space-y-2">
            <Label>Bairro:</Label>
            <Input readOnly value={companyAddress.address.neighborhood} />
          </fieldset>
          <fieldset className="col-span-full md:col-span-1 space-y-2">
            <Label>Complemento:</Label>
            <Input readOnly value={companyAddress.address.complement} />
          </fieldset>
        </div>
