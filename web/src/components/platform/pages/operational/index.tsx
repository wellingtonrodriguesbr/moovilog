  ...
  return (
    <section className="flex flex-col gap-12">
      <header className="flex flex-col gap-4">
        <h1 className="text-2xl md:text-3xl font-medium">Operacional</h1>
        <p className="text-sm">
          Aqui você poderá consultar a programação do dia, gerenciar os suprimentos e verificar avisos importantes.
        </p>
      </header>
