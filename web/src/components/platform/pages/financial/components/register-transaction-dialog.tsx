...
export function RegisterTransactionDialog() {
  ...
  return (
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      ...
      <DialogContent className="rounded-md max-w-[350px] md:max-w-[800px] max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Novo cadastro</DialogTitle>
          <DialogDescription>Preencha os campos abaixo para cadastrar uma nova transação</DialogDescription>
        </DialogHeader>
