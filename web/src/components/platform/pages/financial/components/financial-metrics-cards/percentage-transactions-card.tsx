...
export function PercentageTransactionsCard({ percentageTransactions }: PercentageTransactionsCardProps) {
  return (
    <Card className="h-48 bg-zinc-100 relative">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-5xl">{percentageTransactions}%</CardTitle>
        <CardDescription className="text-zinc-600">Porcentagem de lucro</CardDescription>
        <Activity
          data-financialHealth={financialHealth(percentageTransactions)}
              ...
              <DropdownMenuContent align="center">
                <DropdownMenuItem>
                  <ul className="flex flex-col items-start justify-start gap-2 text-sm">
                    <li>
                      🏆 <strong>Extraordinária</strong>: Acima de <strong>30%</strong>
                    </li>
                    <li>
                      🟢 <strong>Ótima</strong>: Entre <strong>20% e 30%</strong>
                    </li>
                    <li>
                      🔵 <strong>Boa</strong>: Entre <strong>10% e 19%</strong>
                    </li>
                    <li>
                      🟡 <strong>Regular</strong>: Entre <strong>5% e 9%</strong>
                    </li>
                    <li>
                      🟠 <strong>Crítica</strong>: Entre <strong>0% e 4%</strong>
                    </li>
                    <li>
                      🔴 <strong>Prejuízo</strong>: Abaixo de <strong>0%</strong>
                    </li>
                  </ul>
                </DropdownMenuItem>
              </DropdownMenuContent>
