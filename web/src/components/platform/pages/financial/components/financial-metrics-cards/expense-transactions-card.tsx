...
export function ExpenseTransactionsCard({ expenseTransactions }: ExpenseTransactionsCardProps) {
  return (
    <Card className="h-48 bg-rose-100 relative">
      <CardHeader>
        ...
        <CardDescription className="text-rose-600">Total de despesas</CardDescription>
