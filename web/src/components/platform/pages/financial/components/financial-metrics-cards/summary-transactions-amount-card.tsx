...
export function SummaryTransactionsAmountCard({ summaryTransactionsAmount }: SummaryTransactionsAmountCardProps) {
  return (
    <Card className="col-span-1 md:col-span-2 xl:col-span-1 h-48 bg-app-blue-50 relative">
      <CardHeader>
        ...
        <CardDescription className="text-app-blue-600">Saldo atual</CardDescription>
