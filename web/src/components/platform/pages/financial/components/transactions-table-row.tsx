...
export function TransactionsTableRow({
	...
	return (
		<TableRow className="hover:bg-transparent">
			...
			<TableCell className="text-nowrap">
				{formatCurrencyBR(transaction.amountInCents)}
			</TableCell>
			<TableCell className="text-nowrap">
				<Badge
			...
			<TableCell className="text-nowrap max-w-xs text-ellipsis overflow-hidden">
				{transaction.dueDate
					? formatBrazilianDate(transaction.dueDate)
					: "-"}
			</TableCell>
			<TableCell className="text-nowrap">
				{formatBrazilianDate(transaction.createdAt)}
			</TableCell>
			<TableCell className="text-nowrap">
				{formatBrazilianDate(transaction.updatedAt)}
			</TableCell>
