...
export function VehiclesTableRow({ vehicle }: VehcilesTableRowProps) {
  return (
    <TableRow className="hover:bg-transparent">
      <TableCell className="text-nowrap">{formatPlate(vehicle.plate)}</TableCell>
      <TableCell className="text-nowrap">{vehicle.trailerPlate ? formatPlate(vehicle.trailerPlate) : "-"}</TableCell>
      <TableCell className="text-nowrap">{vehicle.brand}</TableCell>
      <TableCell className="text-nowrap">{vehicle.model}</TableCell>
      <TableCell className="text-nowrap">{VEHICLE_CATEGORIES[vehicle.category]}</TableCell>
      <TableCell className="text-nowrap">{VEHICLE_TYPES[vehicle.type]}</TableCell>
      <TableCell className="text-nowrap">{VEHICLE_BODIES[vehicle.body]}</TableCell>
      <TableCell className="text-nowrap">{formatWeight(vehicle.fullLoadCapacity)}kg</TableCell>
      ...
      <TableCell className="text-nowrap">{formatBrazilianDate(vehicle.createdAt.toString())}</TableCell>
