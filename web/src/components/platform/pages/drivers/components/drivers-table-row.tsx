...
export function DriversTableRow({ driver }: DriversTableRowProps) {
  return (
    <TableRow className="hover:bg-transparent">
      ...
      <TableCell className="text-nowrap">{formatPhone(driver.phone)}</TableCell>
      <TableCell className="text-nowrap">{DRIVER_TYPE[driver.type]}</TableCell>
      <TableCell className="text-nowrap">
        <Badge
      ...
      <TableCell className="text-nowrap">{formatBrazilianDate(driver.createdAt.toString())}</TableCell>
