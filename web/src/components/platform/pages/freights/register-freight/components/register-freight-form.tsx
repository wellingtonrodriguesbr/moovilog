...
const formSchema = z
  .object({
    ...
    freightAmountInCents: z.string({ message: "Digite o valor do frete" }).transform((value) => {
  ...
  .refine(
    ...
    {
      path: ["paymentDate"],
      message: "A data de pagamento não pode ser anterior à data do frete.",
    }
  );
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4 w-full">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <SelectVehicle selectedVehicle={field.value} onChangeSelectedVehicle={field.onChange} />
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <SelectDriver selectedDriver={field.value} onChangeSelectedDriver={field.onChange} />
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} value={formatCurrencyBR(field.value)} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col my-0 md:my-[10px]">
                  <FormLabel>Data de pagamento do frete</FormLabel>
                  <DatePicker selectedDate={field.value} onChangeSelectedDate={field.onChange} />
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="EXPRESS">Entrega rápida</SelectItem>
                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="FLAT_RATE">Taxa Fixa</SelectItem>
                      <SelectItem value="WEIGHT_BASED">Por Peso</SelectItem>
                      <SelectItem value="DISTANCE_BASED">Por Distância</SelectItem>
                      <SelectItem value="TIME_BASED">Por Tempo</SelectItem>
                      <SelectItem value="PER_STOP">Por Parada</SelectItem>
                      <SelectItem value="ZONE_BASED">Por Zona</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <SelectRoute selectedRoute={field.value} onChangeSelectedRoute={field.onChange} />
                  <FormMessage />
                </FormItem>
              )}
            />
          ...
          <fieldset className="flex gap-2 justify-end mt-6">
            ...
            <Button disabled={isPendingRegisterFreight} type="submit">
              {isPendingRegisterFreight ? <Loader2 className="size-4 animate-spin" /> : "Cadastrar"}
            </Button>
          </fieldset>
        </form>
      </Form>
