...
export function TotalFreightsAmountCard({ totalFreightsAmount }: TotalFreightsAmountCardProps) {
  return (
    <Card className="min-h-[140px] h-full bg-app-blue-500 relative">
      <CardHeader>
        ...
        <CardDescription className="text-zinc-50">Custo total com fretes</CardDescription>
