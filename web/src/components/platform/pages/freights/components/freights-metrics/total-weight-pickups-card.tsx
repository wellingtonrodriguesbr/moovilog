...
export function TotalWeightPickupsCard({ totalWeightPickups }: TotalWeightPickupsCardProps) {
  return (
    <Card className="min-h-[140px] h-full bg-app-blue-300 relative">
      <CardHeader>
        ...
        <CardDescription className="text-app-blue-700">Peso total de coletas</CardDescription>
