...
export function TotalPickupsCard({ totalPickups }: TotalPickupsCardProps) {
  return (
    <Card className="min-h-[140px] h-full bg-app-blue-200 relative">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-3xl text-app-blue-700">{totalPickups}</CardTitle>
        <CardDescription className="text-app-blue-700">Coletas</CardDescription>
