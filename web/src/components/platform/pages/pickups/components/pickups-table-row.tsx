  ...
  return (
    <TableRow className="hover:bg-transparent">
      <TableCell className="text-nowrap">
        <CopyButton title="Copiar número da coleta" data={pickup.pickupNumber}>
          {pickup.pickupNumber}
        </CopyButton>
      </TableCell>
      <TableCell className="text-nowrap">{pickup.senderName}</TableCell>
      <TableCell className="text-nowrap">{pickup.recipientName}</TableCell>
      <TableCell className="text-nowrap">
        <Badge
      ...
      <TableCell className="text-nowrap">{formatBrazilianDate(pickup.requestedAt.toString())}</TableCell>
      <TableCell className="text-nowrap">{formatBrazilianDate(pickup.scheduledDate.toString())}</TableCell>
      <TableCell className="text-nowrap">
        {pickup.collectedAt ? formatBrazilianDate(pickup.collectedAt.toString()) : "Não coletado"}
      </TableCell>
