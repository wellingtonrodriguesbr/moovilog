  ...
  return (
    <TableHeader className="bg-zinc-100 hover:bg-zinc-100">
      <TableRow className="hover:bg-zinc-100">
        <TableHead className="text-app-blue-900 font-medium text-nowrap rounded-tl-lg">Nome</TableHead>
        <TableHead className="text-app-blue-900 font-medium text-nowrap">E-mail</TableHead>
        <TableHead className="text-app-blue-900 font-medium text-nowrap">Status da conta</TableHead>
        <TableHead className="text-app-blue-900 font-medium text-nowrap">Setor</TableHead>
