...
export function CollaboratorsTableRow({ companyMember }: CollaboratorsTableRowProps) {
  return (
    <TableRow className="hover:bg-transparent">
      <TableCell className="text-nowrap">{companyMember.user.name}</TableCell>
      <TableCell>
        <CopyButton data={companyMember.user.email} title="Copiar e-mail">
      ...
      <TableCell>
        <CollaboratorPermissionsDropdown permissions={companyMember.extraData.permissions} />
      </TableCell>
      <TableCell>{formatBrazilianDate(companyMember.createdAt)}</TableCell>
