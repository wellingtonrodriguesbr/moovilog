    ...
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      ...
      <DialogContent className="rounded-md max-w-[350px] md:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Ao cadastrar um novo(a) colaborador(a), será enviado um e-mail para ele(a) para concluir seu cadastro e
            acessar a plataforma.
          </DialogDescription>
        </DialogHeader>
        <RegisterNewCollaboratorForm onCloseDialog={handleCloseDialog} />
      </DialogContent>
    </Dialog>
  );
}
