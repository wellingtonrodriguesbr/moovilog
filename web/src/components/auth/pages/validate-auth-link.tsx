        ...
        <div className="w-full px-4 flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4">
          {!isValidateAuthLinkPending && status === "success" ? (
            <>
              ...
              <h1 className="text-base md:text-xl text-center">Validado com sucesso, estamos te redirecionando..</h1>
            </>
          ) : null}
          ...
          {isValidateAuthLinkPending && status === "pending" ? (
            <>
              ...
              <p className="text-base md:text-xl text-center">Validando seu código, só um momento por favor...</p>
            </>
          ) : null}
