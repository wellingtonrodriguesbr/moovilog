		...
		>
			...
			<div className="text-white p-4">
				<p className="text-sm md:text-base">
					A nossa plataforma será lançada em breve e você terá acesso
					gratuito para testar a versão beta por tempo indeterminado.
					Entre na lista de espera e garanta seu lugar. Iremos te
					manter informado(a) por e-mail ou WhatsApp.
				</p>
				<Button
