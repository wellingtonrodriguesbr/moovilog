				...
				<div>
					...
					<div className="flex flex-col gap-4 items-start justify-between">
						...
						<p className="max-w-screen-md">
							Com nossa plataforma, você terá mais organização,
							controle e eficiência em todas as áreas do seu
							negócio. Elimine os achismos com dados precisos,
							reduza custos otimizando processos e tome decisões
							estratégicas que impulsionam resultados. Tudo isso
							em uma interface simples, moderna e acessível de
							qualquer lugar.
						</p>
					</div>
					<ul className="relative mt-8">
						{BENEFITS.map((benefit, index) => (
							...
							>
								...
								<p className="text-sm text-zinc-700 ml-6">
									{benefit.description}
								</p>
							</li>
						))}
...
const BENEFITS = [
	...
	},
	{
		...
		description:
			"Automatize processos e minimize falhas humanas ao contar com ferramentas modernas e seguras.",
	},
	{
		title: "Economia de Tempo e Recursos",
		description:
			"Agilize tarefas rotineiras e foque no que realmente importa: expandir o seu negócio.",
	},
	{
	...
	},
	{
		...
		description:
			"Reduza o uso de papel e contribua para práticas mais sustentáveis, modernizando sua transportadora.",
	},
	{
		title: "Segurança e Confiabilidade",
		description:
			"Armazene todas as informações do seu negócio com segurança e sem o risco de perdas ou extravios.",
	},
];
