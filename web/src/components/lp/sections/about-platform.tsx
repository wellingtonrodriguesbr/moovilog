      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row gap-4 items-start justify-between">
          <h2 className="font-semibold text-2xl md:text-3xl max-w-screen-lg leading-normal md:leading-relaxed">
            Tudo pensado para que você tenha mais organização e controle do seu negócio em um único lugar.
          </h2>
          <div className="space-y-2 max-w-screen-sm">
            <p>
              Com a Moovilog, você deixará para trás as inúmeras planilhas e a papelada. Tenha acesso a uma plataforma
              completa para transformar a gestão da sua transportadora.
            </p>
            <Button variant="link" className="text-app-blue-500 pl-0 group" asChild>
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
        {ITEMS.map((item) => (
          <Card key={item.title}>
            <CardHeader className="gap-2">
              ...
              <CardDescription className="text-zinc-600">{item.description}</CardDescription>
            </CardHeader>
        ...
        <Card className="col-span-1 md:col-span-2 xl:col-span-1 bg-app-yellow-200">
          <CardHeader className="gap-2">
            ...
            <CardTitle className="flex items-center gap-2 text-app-blue-900">E Muitos mais...</CardTitle>
