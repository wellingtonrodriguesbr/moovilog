  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "absolute top-4 left-1/2 -translate-x-1/2 text-app-blue-950 text-lg font-medium capitalize",
      ...
      components={{
        PreviousMonthButton(props) {
          return (
            <Button {...props} type="button" variant="outline" className="p-1.5 h-auto mr-2">
        ...
        NextMonthButton(props) {
          return (
            <Button {...props} type="button" variant="outline" className="p-1.5 h-auto">
